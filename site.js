(() => {
  ...
  const screenshots = [
    ...
    ["2-library-dashboard.jpg", "Library Dashboard — Library Index controls"],
    ["3-library-dashboard-result.jpg", "Dashboard results — indexed library view"],
  ...
  const revision = "20260812-build42";
