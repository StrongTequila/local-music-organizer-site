(() => {
  ...
  const screenshots = [
    ...
    ["3-library-dashboard-result.jpg", "Dashboard results — formats, sample rates and review categories"],
    ["3.1-library-refreshes-outdated-music.jpg", "Dashboard — refresh outdated Music.app file information"],
    ...
    ["10-repair-convert-format.jpg", "Repair / Convert — queue and output workflow"],
    ["11-repair-convert-format.jpg", "Repair / Convert — formats, normalization and original handling"],
    ["12-repair-convert-format.jpg", "Repair / Convert — verified batch conversion progress"],
    ["13-playlist-compare.jpg", "Playlist Compare"],
    ["14-track-usage.jpg", "Track Usage"],
    ["15-file-maintenance.jpg", "File Maintenance — permissions, Finder metadata, naming & tag formatting"],
