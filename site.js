(() => {
  ...
  const screenshots = [
    ...
    ["14-file-maintenance.jpg", "File Maintenance"],
    ["15-repair-convert-vinyl-decklinker.jpg", "Vinyl De-click"],
    ["16-quality-duplicates.jpg", "Quality Duplicates"],
    ["17-shuffle-builder.jpg", "Shuffle Builder"],
    ["18-audio-inspector-lossless.jpg", "Audio Inspector — lossless source"],
    ["19-audio-inspector-lossy.jpg", "Audio Inspector — lossy source"],
    ["20-file-search-result.jpg", "File Search results"],
    ["21-live-spectrum.jpg", "Live Spectrum player and waveform"],
    ["22-live-spectrum-options.jpg", "Live Spectrum appearance and gain controls"],
    ["23-Audio-Authenticity-Analyzer.jpg", "Audio Authenticity Analyzer — scan results"],
    ["24-Audio-Authenticity-Analyzer2.jpg", "Audio Authenticity Analyzer — detailed reasoning"],
    ["25-Audio-Authenticity-Analyzer-Playlist.jpg", "Audio Authenticity Analyzer — entire library or selected playlist"]
  ].map(([file, title]) => ({ file, title }));

  const revision = "20260805-build19";
