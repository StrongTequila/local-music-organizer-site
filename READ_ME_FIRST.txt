...
- Updated the website and User Guide for Version 1.1.4 (Build 42).
...
Release notes:
- Website and User Guide updated for Version 1.1.4 (Build 42).
...
Beginner-first documentation refresh (Build 42): clearer task routing, result interpretation, large-library guidance, support logging instructions, and updated 43-page user guide. Existing style.css and site.js are unchanged.
