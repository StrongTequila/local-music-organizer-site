...
- The embedded User Guide is the current 67-page illustrated guide.
- Updated the gallery cache revision so deployed browsers request the current site.js and screenshot assets.


2026-09-07 screenshot/content update:
- Added the current Library Dashboard Empty Artist and Edit Music.app Tags screenshots to the page content and full gallery.
- Added the current Classic Live Spectrum screenshots: base analyzer, Current Queue, Track Card and playlist tree.
- Added matching 1200-pixel optimized thumbnails while preserving every full-resolution original screenshot.
- Added two keyboard-accessible inline screenshot switchers; selecting a preview reuses the existing full-size modal viewer.
- Updated cache revisions for index.html, style.css, site.js and screenshot thumbnails.
- Kept the bundled current User Guide PDF unchanged.


2026-09-07 Elektronika Mini Player documentation update:
- Added screenshots/29-mini-player.jpg and a matching optimized 1200-pixel thumbnail.
- Added an interactive Elektronika Mini Player showcase to the Live Spectrum section and the full screenshot gallery.
- Documented the compact player controls and its relationship to the full Live Spectrum Player.
- Replaced LocalMusicOrganizer_UserGuide.pdf with the 68-page guide containing section 18.8 Elektronika Mini Player.
- Updated cache revision to 20260907c.

2026-09-12 Setup / external-location documentation update:
- Replaced screenshots/1-settings.jpg with the current Setup screen and regenerated only its matching 1200-pixel thumbnail.
- Updated the first gallery caption and screenshot cache revision; the existing dynamic gallery/modal behavior is unchanged.
- Clarified the existing first-use/support text for macOS folder permission requests, saved external locations, muted offline warnings and Forget.
- LocalMusicOrganizer_UserGuide.pdf is the current 68-page guide with the updated Setup pages.


2026-09-14 Health / Setup website update:
- Added the second current Setup screenshot to the interactive page and full screenshot gallery.
- Added a two-tab Setup showcase for folders/access versus notifications/index/diagnostics.
- Added the current Health Check screenshot with Album Completeness, Track / Disc Numbering, Relink This Folder and Remove Missing Record controls.
- Added a multi-tab Health Check showcase using the existing full-resolution modal, Previous/Next buttons, Left/Right keyboard navigation and Escape-to-close behavior.
- Updated Recent Updates, beginner routing, Library Index guidance and Support for the optional incomplete-new-album watcher, verified Track/Disc cleanup, folder relinking, Missing Record persistence and exact-path orphan import.
- Added matching high-quality 1200-pixel thumbnails for screenshots/1-settings.jpg, screenshots/1.2-settings.jpg and screenshots/8.6-health-check.jpg. The full-resolution originals remain untouched and are still used by the modal viewer.
- The bundled LocalMusicOrganizer_UserGuide.pdf was already current and was not modified by this website update.
- Updated the screenshot/cache revision to 20260914b.
