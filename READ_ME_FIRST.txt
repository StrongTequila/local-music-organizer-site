...
Plain-language documentation refresh: clearer task routing, result interpretation, large-library guidance, support logging instructions, and updated 43-page user guide. Existing style.css and site.js are unchanged.
